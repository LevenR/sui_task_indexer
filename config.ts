...
export const CONFIG = {
	...
	STBTC_RESERVE_ID: process.env.STBTC_RESERVE_ID || 14,   //14 is the reserve id for STBTC
	BORROW_RESERVE_ID: process.env.BORROW_RESERVE_ID || 8,  //8 is the reserve id for WBTC
	STBTC_SUPPLY_THRESHOLD: process.env.STBTC_SUPPLY_THRESHOLD || 100000, //0.001 stBtc is the threshold for supply
};